...
<div id="mobileSidebar" class="fixed inset-0 z-50 hidden">
    ...
    <div class="fixed left-0 top-0 h-full w-64 bg-white shadow-lg">
        <div class="flex flex-col h-full">
            ...
            <div class="p-4 border-t">
                <button type="button" onclick="showLogoutModal()" class="w-full flex items-center px-3 py-2 text-sm font-medium rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-50">
                    <i class="fas fa-sign-out-alt mr-3 h-4 w-4"></i>
                    Logout
                </button>
            </div>
